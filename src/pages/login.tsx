...
const LoginPage = () => {
  ...
  return (
    <div className='flex min-h-screen w-full flex-col items-center justify-center gap-8 bg-zinc-200 lg:flex-row lg:gap-16'>
      ...
      <section className='flex w-96 flex-col items-center gap-4 rounded-2xl bg-zinc-500 p-6 font-medium shadow-2xl'>
        ...
        <button
          ...
          disabled={isDisabled}
          className='flex w-full items-center justify-center gap-2 rounded-lg bg-zinc-300 fill-zinc-800 py-2 px-4 text-xl font-semibold text-zinc-800 shadow-xl transition-colors duration-300 hover:bg-zinc-100 disabled:cursor-not-allowed disabled:opacity-20'
        >
